...
public class test_EuropeanCallPayOut extends TestCase
{
	...
	public void testEuropeanCallPayOut0()
	{
		double r = 0.0;
		double strike = 100.0;
		EuropeanCallPayOut P = new EuropeanCallPayOut(r, strike);
	...
	// In this case payoff should equal zero.
	public void testEuropeanCallPayOut1()
	{
		double r = 0.0;
		double strike = 110.0;
		EuropeanCallPayOut P = new EuropeanCallPayOut(r, strike);
